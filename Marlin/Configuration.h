...
#define STRING_CONFIG_H_AUTHOR "(Dodecadaemon)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Custom CR-10 Bed Tuned for 60C
  //#define  DEFAULT_bedKp 646.81
  //#define  DEFAULT_bedKi 127.35
  //#define  DEFAULT_bedKd 821.28
